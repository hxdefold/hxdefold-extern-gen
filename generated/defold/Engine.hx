...
class EngineMessages {
    ...
    **/
    static var exit(default, never) = new Message<EngineMessageExit>("exit");
    ...
    **/
    static var reboot(default, never) = new Message<EngineMessageReboot>("reboot");
    ...
    /**
        ...
        set in run-time
    **/
    static var set_update_frequency(default, never) = new Message<EngineMessageSetUpdateFrequency>("set_update_frequency");
    ...
    **/
    static var start_record(default, never) = new Message<EngineMessageStartRecord>("start_record");
